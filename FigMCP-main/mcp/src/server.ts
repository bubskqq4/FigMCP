...
import { registerFileLockTools } from "./tools/file-lock/index.js";
...
export async function getServer(server: Server): Promise<McpServer> {
    ...
    // File Lock tools (6) - Agent coordination for parallel work
    registerFileLockTools(mcpServer, taskManager);
