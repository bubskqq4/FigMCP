...
export async function startSTDIO() {
    ...
    try {
        ...
        socketServer = new Server(httpServer, {
            ...
            pingInterval: 1000,       // 1 second - very responsive keep-alive for instant execution
            connectTimeout: 86400000, // 24 hours - never timeout on connect
            // Allow larger payloads for complex Figma data and concurrent operations
            maxHttpBufferSize: 50e6,  // 50MB - increased for concurrent tool execution
